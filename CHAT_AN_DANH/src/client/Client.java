...
public class Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("   Không nên để lộ bất cứ thông tin cá nhân nào !");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(11, 14, 300, 440));
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 460, 630, 0));
                    ...
                    try {
                        ...
                        while (true) {
                            ...
                            if (messageSplit[0].equals("update-online-list")) {
                                ...
                                String online ="";
                                String[] onlineSplit = messageSplit[1].split("-");
                                for(int i=offlineList.size(); i<3; i++){
//                                    offlineList.add(onlineSplit[i]);
                                    System.out.println(onlineSplit.length);
                                    online+="Client "+(i+1)+" đang offline\n";
                                }
